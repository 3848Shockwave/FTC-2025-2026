...
class AutonomousRedScore extends NextFTCOpMode{
    ...
    private Pose   startPose = RobotConfig.AutonomousStartEndPoses.FARSIDERED.getStartPose();// Start Pose of our robot.
    private Pose   score = new Pose(96, 86, Math.toRadians(270)); // Scoring Pose of our robot.
    private Pose  readyPose0 = new Pose(89, 93, Math.toRadians(0));
    private Pose  pickUpBalls0 = new Pose(116, 95, Math.toRadians(0));
    private Pose  readyPose1 = new Pose(89, 71, Math.toRadians(0));
    private Pose   pickUpBalls1 = new Pose(116, 71, Math.toRadians(0));
    private Pose  readyPose2 = new Pose(89, 36, Math.toRadians(0));
    private Pose  pickUpBalls2 = new Pose(116, 36, Math.toRadians(0));
...
class AutonomousBlueScore extends NextFTCOpMode{
    ...
    private Pose   startPose = RobotConfig.AutonomousStartEndPoses.FARSIDEBLUE.getStartPose();// Start Pose of our robot.
