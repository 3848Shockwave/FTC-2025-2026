...
public final class RobotConfig {
    ...
    public enum AutonomousStartEndPoses {
        GOALSIDEREDMOVE(new Pose(123, 123, Math.toRadians(37)), new Pose(90.648, 116.139, Math.toRadians(200))),
        GOALSIDEREDSCORE(new Pose(123, 123, Math.toRadians(37)), new Pose(96.310, 96.825, Math.toRadians(230))),
        GOALSIDEBLUEMOVE(new Pose(20.75, 123.5, Math.toRadians(143)), new Pose(50.343, 115.939, Math.toRadians(320))),
        ...
        FARSIDEREDSCORE(new Pose(84, 8.5, Math.toRadians(270)), new Pose(86.435, 83.670, Math.toRadians(225))),
